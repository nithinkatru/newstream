...
class _VideoUploadPageState extends State<VideoUploadPage> {
          ...
          child: _videoFile == null
            ...
            children: [
              ...
              OutlinedButton(
                ...
                child: Text('Select files', style: TextStyle(color: Colors.grey[700])),
              ),
            ],
          )
              : Stack(
  ...
  Widget _buildThumbnailSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Thumbnail', style: TextStyle(color: Colors.black87, fontSize: 18, fontWeight: FontWeight.bold)),
        SizedBox(height: 10),
        Row(
          children: [
  ...
  Widget _buildVisibilitySection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Visibility', style: TextStyle(color: Colors.black87, fontSize: 18, fontWeight: FontWeight.bold)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            // Details Section
            Text('Details', style: TextStyle(color: Colors.black87, fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 10),
